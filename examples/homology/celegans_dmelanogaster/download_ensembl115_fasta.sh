...
wget -c https://ftp.ensembl.org/pub/release-115/fasta/drosophila_melanogaster/pep/Drosophila_melanogaster.BDGP6.54.pep.all.fa.gz

gunzip -f Caenorhabditis_elegans.WBcel235.pep.all.fa.gz
gunzip -f Drosophila_melanogaster.BDGP6.54.pep.all.fa.gz
